...
const GAME_VERSION = '0.23.2-alpha';
...
const VERSION_NOTES = {
  '0.23.2-alpha': [
    { cat: 'Änderung', text: 'Die Vertonung setzt beim Abspielen sofort ein: Die Stimme wird bereits beim Öffnen des Dialogs geladen, statt erst beim Klick auf Abspielen.' },
  ],
  '0.23.1-alpha': [
  ...
  '0.22.10-alpha': [
    { cat: 'Änderung', text: 'Der letzte Button einer Dialog-Serie heißt jetzt "Schließen" statt "Weiter" — er kündigt damit an, dass der Dialog endet (Story-Einträge, Monologe, Hinweis-Dialoge).' },
  ],
  '0.22.9-alpha': [
    { cat: 'Bugfix', text: 'Yevas Handelsnetz-Quest startete nicht: Investitionsangebot war nach Gilden-Quest nicht erreichbar, Wartetimer wurde nie gestartet — behoben.' },
  ],
  '0.22.8-alpha': [
  ...
  '0.22.4-alpha': [
    ...
    { cat: 'Verbesserung', text: 'Update-Banner erscheint jetzt nach 15 Sekunden (statt 3 Minuten), damit Spieler schneller über neue Versionen informiert werden.' },
  ],
  '0.22.3-alpha': [
