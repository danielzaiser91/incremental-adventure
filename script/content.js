  ...
  el.innerHTML = `
    <div class="feature-stage">
      ...
      <div class="settings-group">
        ...
        <div class="settings-audio-row">
          <label class="settings-audio-label">Vorlesen (Beta)</label>
          <div class="audio-control">
            <input type="checkbox" id="narration-toggle"
              ${audioSettings.narrationEnabled ? 'checked' : ''}
              onchange="setNarrationEnabled(this.checked)">
            <input type="range" min="0" max="1" step="0.05"
              value="${audioSettings.narrationVolume}"
              oninput="setNarrationVolume(parseFloat(this.value))"
              ${!audioSettings.narrationEnabled ? 'disabled' : ''}>
            <span class="audio-volume-label">${Math.round(audioSettings.narrationVolume * 100)}%</span>
          </div>
        </div>
        <div class="settings-audio-row">
          <label class="settings-audio-label">Vorlesen automatisch starten</label>
          <div class="audio-control">
            <input type="checkbox" id="narration-autoplay-toggle"
              ${audioSettings.narrationAutoplay ? 'checked' : ''}
              onchange="setNarrationAutoplay(this.checked)">
          </div>
        </div>
      </div>
      ...
      <div class="settings-group">
        ...
        <a href="https://discord.gg/QuMTbDAfPd" target="_blank" class="discord-link-btn">
